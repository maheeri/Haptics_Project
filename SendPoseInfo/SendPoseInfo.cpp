...
//{
//    hdGetDoublev(HD_CURRENT_FORCE, forceData.forceValues);
//    hdGetDoublev(HD_CURRENT_JOINT_TORQUE, forceData.jointTorqueValues);
//    hdGetDoublev(HD_CURRENT_GIMBAL_TORQUE, forceData.gimbalTorqueValues);
//
//	fprintf(ofp, "%g, %g, %g, %g, %g, %g, %g, %g, %g \n",
//				forceData.forceValues[0], 
//                forceData.forceValues[1], 
//                forceData.forceValues[2],
//				forceData.gimbalTorqueValues[0],
//				forceData.gimbalTorqueValues[1],
//				forceData.gimbalTorqueValues[2],
//				forceData.jointTorqueValues[0],
//				forceData.jointTorqueValues[1],
//				forceData.jointTorqueValues[2]);
//
